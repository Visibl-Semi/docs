...
<CodeGroup>
```bash Linux x64
curl -L https://github.com/Visibl-Semi/releases/latest/download/visibl-linux-x64.tar.gz | tar xz
sudo mv visibl /usr/local/bin/
```

```bash macOS x64
curl -L https://github.com/Visibl-Semi/releases/latest/download/visibl-darwin-x64.tar.gz | tar xz  
sudo mv visibl /usr/local/bin/
```

```bash macOS ARM64
curl -L https://github.com/Visibl-Semi/releases/latest/download/visibl-darwin-arm64.tar.gz | tar xz
sudo mv visibl /usr/local/bin/
```

```bash Windows
# Download from: https://github.com/Visibl-Semi/releases/latest/download/visibl-win-x64.zip
...
```bash
# Clone repository
git clone https://github.com/Visibl-Semi/visibl-cli.git
cd visibl-cli
...
<Info>
**Requirements**: Rust 1.70+ and Node.js 18+ for building from source
</Info>
</Tab>
</Tabs>
